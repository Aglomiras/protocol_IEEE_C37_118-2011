...
public class Frame_Data_IEEE_C37_118_2011 {
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------
     * Переменная для хранения количества фазоров-----------------------------------------------------------------------
     * -----------------------------------------------------------------------------------------------------------------
     */
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------
     * Переменная для хранения количества аналоговых каналов------------------------------------------------------------
     * -----------------------------------------------------------------------------------------------------------------
     */
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------
     * Переменная для хранения количества цифровых каналов--------------------------------------------------------------
     * -----------------------------------------------------------------------------------------------------------------
     */
    ...
    public String toString() {
        return "PMU [IEEE C37.118-2011] { " + '\n' +
                "\t\t\tFlag: " + flag + '\n' +
                "\t\t\tPhasors: \n" + toStringMeasurement() +
                "\t\t\tFrequency deviation: " + frequencyDeviation + " mHz" + '\n' +
                "\t\t\tRate: " + rate + " Hz/s" + '\n' +
                "\t\t\tAnalog: \n" + toStringAnalog() +
    ...
    public String toStringMeasurement() {
        ...
        for (int i = 0; i < this.measurements.size(); i++) {
            measurements.append("\t\t\t\t").append(i + 1).append(" phasor: ").
                    append(this.measurements.get(i).toStringComplex()).append('\n');
        }
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------
     * Метод по созданию всех нужных сигналов, в зависимости от их количества-------------------------------------------
     * -----------------------------------------------------------------------------------------------------------------
     */
    public void creatorSignal() {
        /**-------------------------------------------------------------------------------------------------------------
         * Создаем фазоры-----------------------------------------------------------------------------------------------
         * -------------------------------------------------------------------------------------------------------------
         * */
        for (int i = 0; i < this.numPhasor; i++) { //14
            this.measurements.add(new dataMeasurement());
        }

        /**-------------------------------------------------------------------------------------------------------------
         * Создаем аналоговые каналы------------------------------------------------------------------------------------
         * -------------------------------------------------------------------------------------------------------------
         * */
